document.addEventListener("DOMContentLoaded", function() {
    ...
    const cardContents = [
        { subject: "2nd Clinical Cyto", image: 'images/25.png', pdf: 'MED TECH/2ND YEAR MEDTECH/1ST SEM/CYTOGENETICS/2ND CLINICAL CYTO .pdf' },
        { subject: "Essential Genetics", image: 'images/25.png', pdf: 'MED TECH/2ND YEAR MEDTECH/1ST SEM/CYTOGENETICS/ESSENTIAL GENETICS .pdf' },
        { subject: "Genetics Principles", image: 'images/25.png', pdf: 'MED TECH/2ND YEAR MEDTECH/1ST SEM/CYTOGENETICS/GENETICS PRINCIPLES.PDF' },
        { subject: "Genetics Principles & Analysis", image: 'images/25.png', pdf: 'MED TECH/2ND YEAR MEDTECH/1ST SEM/CYTOGENETICS/GENETICS PRINCIPLES & ANALYSIS .pdf' },
        { subject: "Human Genetics", image: 'images/25.png', pdf: 'MED TECH/2ND YEAR MEDTECH/1ST SEM/CYTOGENETICS/9TH HUMAN GENETICS .PDF' },
        { subject: "Tamarin - Principles of Genetics 7E", image: 'images/25.png', pdf: 'MED TECH/2ND YEAR MEDTECH/1ST SEM/CYTOGENETICS/TAMARIN - PRINCIPLES OF GENETICS 7E.pdf' },
        { subject: "The Principles of Clinical Cyto", image: 'images/25.png', pdf: 'MED TECH/2ND YEAR MEDTECH/1ST SEM/CYTOGENETICS/3RD THE PRINCIPLES OF CLINICAL CYTO.pdf' }
    ];
